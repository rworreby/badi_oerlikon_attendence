...
az monitor metrics list \
  ...
  --resource-name "$FUNCTION_APP/websocket_listener" \
...
az monitor metrics alert create \
  ...
  --resource-group $RESOURCE_GROUP \
  --scopes "/subscriptions/cc569079-9e12-412d-8dfb-a5d60a028f75/resourceGroups/$RESOURCE_GROUP/providers/Microsoft.Web/sites/$FUNCTION_APP" \
