...
async def main(mytimer: func.TimerRequest) -> None:
    ...
    try:
        ...
        listener = WebSocketListener(url=websocket_url, duration_seconds=300)
...
class WebSocketListener:
    ...
    def __init__(self, url, duration_seconds=300, timeout_per_message=1.0):
        """
...
async def fallback_get_request():
...
try:
    ...
    occupancy = await fallback_get_request()
